...
U8G2_SSD1306_128X64_NONAME_F_SW_I2C MyPrint::u8g2(U8G2_R0, SCL, SDA, U8X8_PIN_NONE);
        ...
        if (args.indexOf('.') != -1) {
            ...
            if (command_1 == "print") {
                if (command_2 == "Serial") {
                    ...
                    MyPrint::displayText(params);
                } else if (command_2 == "displayRect") {
                    MyPrint::displayRect(params);
                } else if (command_2 == "displayPixel") {
                    MyPrint::displayPixel(params);
                } else if (command_2 == "clear") {
                    MyPrint::displayClear();
                } else {
